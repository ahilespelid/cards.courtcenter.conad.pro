<?php
//
define('C_REST_CLIENT_ID','local.6446d607ba03c7.06728029');//Application ID
//
define('C_REST_CLIENT_SECRET','4qeoAi9awRs4SDMRH0QOYOrA0iyDviFyhPi7Vop3aSLbiAouUj');//Application key
// or
