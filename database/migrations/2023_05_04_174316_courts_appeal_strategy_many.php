...
class CourtsAppealStrategyMany extends Migration
{
     ...
     */
    public function up(){
        Schema::connection('two')->create('courts_appeal_strategy__many', function (Blueprint $table) {
     ...
     * @return void
     */
    public function down(){Schema::connection('two')->dropIfExists('courts_appeal_strategy__many');}
}
