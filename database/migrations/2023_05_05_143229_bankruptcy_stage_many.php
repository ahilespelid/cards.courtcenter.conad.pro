...
class BankruptcyStageMany extends Migration
{
     ...
     */
    public function up(){
        Schema::connection('two')->create('bankruptcy_stage__many', function (Blueprint $table) {
     ...
     * @return void
     */
    public function down(){Schema::connection('two')->dropIfExists('bankruptcy_stage__many');}
}