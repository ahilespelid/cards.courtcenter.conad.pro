            ...
            <div class="main_class courts content__wrapper">
                <div class="courts__left">
                    ...
                    <div class="courts__left__body">
                        ...
                        <div class="instances">
                            <div class="first_instance instance flex {{ 'FI' == $instance ? 'gray__block' : '' }}">
                                <h2>
                                    Первая инстанция
                                </h2>
                                <a href="{{ route('front.report', ['deal_id' => $deal_id, 'instance' => 'FI']) }}">
                                    <img class="big_arrow" src="/assets/img/svg/big_arrow.svg" alt=">">
                                </a>
                            </div>
                            
                            <!-- первый мобильный блок -->
@if($agent->isMobile())
                            <div class="first__apellation appeal mobile {{ 'FI' == $instance ? '' : 'none' }}">
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    ...
                                    <p class="blue__text">
                                    {!! empty($html = rr($data['UF_CRM_CONAD_CRD091'])) ? $nd : (empty($link = rr($data['UF_CRM_CONAD_CRD122'])) ? $html : '<a target="_blank" href="'.$link.'">'.$html.'</a>') !!}
                                    </p>
                                </div>
                                <div class="flex">
                                ...
                                <div class="flex">
                                    ...
                                    <p class="black__text date">{!! empty($html = rr($data['BEGINDATE'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    ...
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_1640249453073'])) ? $nd : $html !!}<span class="black__text price currency"> РУБ</span></p>
                                </div> 
                            </div>
                            <div class="gray__block courts__information">
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <div class="files__first">     
                                        <div class="column">
                                            <p class="gray__text column_text">Претензия</p>
                            ...
                            <div class="courts__prices">
                                ...
                                <div class="gray__block courts__information ">
                                    ...
                                    <p class="black__text price date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD016'])) ? $nd : $html !!}</p>
                                </div>
                            </div>
                            <div class="gray__block courts__information">
                                <div class="flex">
                            ...
                            <div class=" courts__prices">
                                <div class="gray__block courts__information">
                                    ...
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD011'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                                <div class="gray__block courts__information">
                                    <p class="gray__text">Удовлетворенные требования</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD012'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                                <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Госпошлина</p>
                                    <p class="gray__text">Платежное поручение</p>
                                </div>
                                <div class="flex">
                                    <div class="flex files__first">
                                        <div>
                                            <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD004'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                            <p class="gray__text">Дата оплаты: <span class="black__text date-align date-alighn_mobile">{!! empty($html = rr($data['UF_CRM_CONAD_CRD006'])) ? $nd : $html !!}</span></p>
                                        </div> 
                                    </div>
                            ...
                            <div class="gray__block courts__information interim__measures">
                                ...
                                <div class="flex">
                                    ...
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_1666170845189'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                            <div class="gray__block courts__information">
                                <div class="flex">
                            ...
                            <div class=" courts__prices">
                                <div class="gray__block courts__information">
                                    ...
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD018'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="gray__block courts__information">
                                    <p class="gray__text">Дата принятия жалобы</p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD019'])) ? $nd : $html !!}</p>
                                </div>
                            </div>
                            <div class="gray__block courts__information total__price">
                                <div class="flex">
                                    <p class="gray__text">Сумма оказанных юридических услуг</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD020'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                        </div>
@endif
                            <div class="second_instance instance flex {{ 'AI' == $instance ? 'gray__block' : '' }}">
                                <h2>
                                    Апелляционная инстанция
                                </h2>
                                <a href="{{ route('front.report', ['deal_id' => $deal_id, 'instance' => 'AI']) }}">
                                    <img class="big_arrow" src="/assets/img/svg/big_arrow.svg" alt>
                                </a>
                            </div>
                              
                            <!-- второй мобильный блок -->
@if($agent->isMobile())                            
                            <div class="second__apellation appeal mobile {{ 'AI' == $instance ? '' : 'none' }}">
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text width-limiter">Номер дела в суде аппеляционной инстанции</p>
                                    <p class="blue__text">
                                    {!! empty($html = rr($data['UF_CRM_CONAD_CRD101'])) ? $nd : (empty($link = rr($data['UF_CRM_CONAD_CRD133'])) ? $html : '<a target="_blank" href="'.$link.'">'.$html.'</a>') !!}
                                    </p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Суд</p>
                                    <p class="black__text width-limiter press-to-right">{!! empty($html = rr($data['UF_CRM_CONAD_CRD126'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Судья</p>
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Дата подачи жалобы</p>
                                    <p class="black__text date-align date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD027'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Дата принятия судом</p>
                                    <p class="black__text date-align date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD028'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Дата фактического изготовления апелляционного определения</p>
                                    <p class="black__text date-align date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD033'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Дата получения апелляционного определения</p>
                                    <p class="black__text date-align date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD034'])) ? $nd : $html !!}</p>
                                </div>
                            </div>
                            ...
                            <div class="gray__block courts__information progress">
                                <p class="progress__header gray__text date">Дата назначения слушания</p>
                            ...
                            <div class=" courts__prices">
                                <div class="gray__block courts__information">
                                    ...
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD031'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                                <div class="gray__block courts__information">
                                    <p class="gray__text">Сумма удовлетворенных судом требований</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD032'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div> 
                            <div class="gray__block courts__information">
                                <div class="flex">
                                ...
                                <div class="flex">
                                    <div class="flex files__first">
                                        <div>
                                            <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD022'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                        </div> 
                                    </div>
                            ...
                            <div class="gray__block courts__information total__price">
                                <div class="flex">
                                    ...
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD036'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                        
                        </div>
@endif                        
                            <div class="third_instance instance flex {{ 'CI' == $instance ? 'gray__block' : '' }}">
                                <h2>
                                    Кассационная инстанция
                                </h2>
                                <a href="{{ route('front.report', ['deal_id' => $deal_id, 'instance' => 'CI']) }}">
                                    <img class="big_arrow" src="/assets/img/svg/big_arrow.svg" alt>
                                </a>
                            </div>
...
@if($agent->isMobile())
                            <div class="third__apellation appeal {{ 'CI' == $instance ? '' : 'none' }}">
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text width-limite">Номер дела в суде кассационной инстанции</p>
                                    <p class="blue__text">
                                    {!! empty($html = rr($data['UF_CRM_CONAD_CRD102'])) ? $nd : (empty($link = rr($data['UF_CRM_CONAD_CRD137'])) ? $html : '<a target="_blank" href="'.$link.'">'.$html.'</a>') !!}
                                    </p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Суд</p>
                                    <p class="black__text width-limite">{!! empty($html = rr($data['UF_CRM_CONAD_CRD128'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Судья</p>
                            ...
                            <div class="gray__block courts__information">
                                ...
                                <div class="flex">
                                    <div class="flex files__first">
                                        <div>
                                            <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD038'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                        </div> 
                                    </div>
                            ...
                            <div class=" courts__prices">
                                <div class="gray__block courts__information">
                                    <p class="gray__text">Заявленные требования</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD044'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                                <div class="gray__block courts__information">
                                    <p class="gray__text">Удовлетворенные требования</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD045'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                            <div class="gray__block courts__information total__price">
                                <div class="flex">
                                    <p class="gray__text">Сумма оказанных юридических услуг</p>
                                    <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD049'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                </div>
                            </div>
                        </div>
@endif                        
...
@if($agent->isDesktop())
                    <div class="courts__right"> 
                        <div class="first__apellation appeal {{ 'FI' == $instance ? '' : 'none' }}">
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Истец</p>
                                    <p class="black__text">{!! empty($html = rr($data['UF_CRM_CONAD_CRD130'])) ? $nd : $html !!}</p>
                            ...
                            <div class="gray__block courts__information">
                                ...
                                <div class="flex">
                                    <p class="gray__text">Ближайшее заседание</p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_1702719450'])) ? $nd : $html !!}</p>
                                </div>
                            </div>
                            <div class="gray__block courts__information">
                                <div class="flex">
                            ...
                            <div class="courts__prices">
                                <div class="gray__block courts__information ">
                                    ...
                                    <p class="black__text price date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD015'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="gray__block courts__information ">
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Срок на обжалование решения</p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD014'])) ? $nd : $html !!}</p>
                                </div> 
                            </div>
                            <div class="gray__block courts__information">
                                <div class="flex">
                            ...
                            <div class=" courts__prices">
                                ...
                                <div class="flex">
                                    <div class="flex files__first">
                                        <div>
                                            <p class="black__text price">{!! empty($html = rr($data['UF_CRM_CONAD_CRD004'])) ? $nd : $html !!}<span class="black__text price currency">РУБ</span></p>
                                            <p class="gray__text ">Дата оплаты: <span class="black__text date-align">{!! empty($html = rr($data['UF_CRM_CONAD_CRD006'])) ? $nd : $html !!}</span></p>
                                        </div> 
                                    </div>
                                    <div class=" files__second ">{!! empty($html = rr($data['UF_CRM_CONAD_CRD005'])) ? $nd : $html !!}</div>
                                </div>
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Дата вступления судебного акта в законную силу</p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD013'])) ? $nd : $html !!}</p>
                                </div> 
                            </div>
                            <div class=" courts__prices">
                                <div class="gray__block courts__information">
                        ...
                        <div class="second__apellation appeal {{ 'AI' == $instance ? '' : 'none' }}">
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text width-limiter">Номер дела в суде аппеляционной инстанции</p>
                                    <p class="blue__text">
                        ...
                        <div class="gray__block courts__information">
                            ...
                            <div class="gray__block courts__information">
                                <div class="flex">
                                    <p class="gray__text">Дата фактического изготовления судебного акта </p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD046'])) ? $nd : $html !!}</p>
                                </div>
                                <div class="flex">
                                    <p class="gray__text">Дата получения постановления суда</p>
                                    <p class="black__text date">{!! empty($html = rr($data['UF_CRM_CONAD_CRD047'])) ? $nd : $html !!}</p>
                                </div>
                            </div> 
                            <div class="gray__block courts__information">
                                <div class="complaint flex">
